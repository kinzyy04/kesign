...
export const HeroSection = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-between pt-32 pb-16 overflow-hidden bg-[#F6F6F6] select-none">
      
      {/* Kyne Jang Exact Semi-Circular Glowing Orb / Dome at Bottom Center */}
      <div className="absolute -bottom-[220px] sm:-bottom-[280px] left-1/2 -translate-x-1/2 w-[500px] sm:w-[720px] h-[500px] sm:h-[720px] rounded-full bg-[#FF5733] blur-[75px] opacity-75 pointer-events-none z-0" />
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 sm:px-8 w-full text-left">
        <div className="relative py-8">
          ...
          >
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-normal text-[#111111] leading-[0.95] tracking-tight font-serif-italic">
              ...
              <span className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-serif-italic font-normal text-[#666666] tracking-normal block -mt-1 sm:-mt-2">
                by IITD Students
              </span>
            </h1>

            <p className="mt-8 max-w-2xl text-base sm:text-xl text-[#444444] font-normal leading-relaxed font-sans">
