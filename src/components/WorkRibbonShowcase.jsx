...
const ribbonItems = [
  ...
  { id: 'r-3', src: '/assets/portfolio/restaurant-gulmohar-house-menu.webp', label: 'Gulmohar House Menu', category: '03 Restaurant & Café', alt: 'Gulmohar House Dining Menu' },
  { id: 'r-4', src: '/assets/portfolio/ecommerce-auren-botanical-serum.webp', label: 'AUREN Serum Visual', category: '04 Products & E-Com', alt: 'AUREN Botanical Serum Product Visual' },
  { id: 'r-5', src: '/assets/portfolio/editorial-modern-catalogue-layout.webp', label: 'Storybook Layout', category: '05 Editorials', alt: 'Editorial Storybook Layout' },
  { id: 'r-6', src: '/assets/portfolio/events-creative-summit-poster.webp', label: 'Design Summit 2026', category: '06 Events', alt: 'Prism Design Summit Poster' },
  { id: 'r-7', src: '/assets/portfolio/infographics-data-visualization-matrix.webp', label: 'Process Matrix', category: '07 Infographics', alt: 'Nexus Process Architecture Infographic' },
  { id: 'r-8', src: '/assets/portfolio/pod-club-1994-tote-front.webp', label: 'CLUB 1994 Tote', category: '08 Print-on-Demand', alt: 'CLUB 1994 Streetwear Canvas Tote' },
  ...
  { id: 'r-12', src: '/assets/portfolio/restaurant-mellow-milk-cafe-menu.webp', label: 'Mellow & Milk Menu', category: '03 Restaurant & Café', alt: 'Mellow and Milk Cafe Menu' },
  { id: 'r-13', src: '/assets/portfolio/ecommerce-form-linen-apparel.webp', label: 'FORM / 01 Linen', category: '04 Products & E-Com', alt: 'FORM 01 Linen Lookbook' },
  { id: 'r-14', src: '/assets/portfolio/editorial-minimalist-publication-cover.webp', label: 'Publication Cover', category: '05 Editorials', alt: 'Minimalist Publication Cover Layout' },
  { id: 'r-15', src: '/assets/portfolio/pod-offline-tee-back-graphic.webp', label: 'OFFLINE Back Graphic', category: '08 Print-on-Demand', alt: 'OFFLINE Cyber Minimalist T-Shirt Graphic' },
