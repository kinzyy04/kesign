    ...
    <section id="ai-philosophy" className="py-24 sm:py-32 bg-[#F6F6F6] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 relative z-10">
        ...
        <div className="max-w-4xl">
          ...
          <div className="mt-8 space-y-6 text-sm sm:text-xl text-[#666666] leading-relaxed font-normal">
            <p>
        ...
        {/* Feature Cards Grid */}
        <div className="mt-16 grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          <div className="p-4 sm:p-8 rounded-3xl bg-white/95 backdrop-blur-md border border-[#E5E5E5] flex flex-col justify-between shadow-sm hover:border-[#FF5733]/40 transition-colors">
            <div>
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-[#F6F6F6] text-[#111111] flex items-center justify-center mb-6">
                <FastForward size={22} className="text-[#FF5733]" />
              </div>
              <h3 className="text-base sm:text-lg font-bold text-[#111111]">Rapid Exploration</h3>
              <p className="mt-2 text-[11px] sm:text-sm text-[#666666] leading-relaxed">
          ...
          <div className="p-4 sm:p-8 rounded-3xl bg-white/95 backdrop-blur-md border border-[#E5E5E5] flex flex-col justify-between shadow-sm hover:border-[#FF5733]/40 transition-colors">
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-[#111111]">Human QA & Taste</h3>
              <p className="mt-2 text-[11px] sm:text-sm text-[#666666] leading-relaxed">
          ...
          <div className="p-4 sm:p-8 rounded-3xl bg-white/95 backdrop-blur-md border border-[#E5E5E5] flex flex-col justify-between shadow-sm hover:border-[#FF5733]/40 transition-colors">
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-[#111111]">Zero Repetitive Lag</h3>
              <p className="mt-2 text-[11px] sm:text-sm text-[#666666] leading-relaxed">
          ...
          <div className="p-4 sm:p-8 rounded-3xl bg-white/95 backdrop-blur-md border border-[#E5E5E5] flex flex-col justify-between shadow-sm hover:border-[#FF5733]/40 transition-colors">
            <div>
              ...
              <h3 className="text-base sm:text-lg font-bold text-[#111111]">Complete Alignment</h3>
              <p className="mt-2 text-[11px] sm:text-sm text-[#666666] leading-relaxed">
